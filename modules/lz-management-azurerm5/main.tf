...
resource "azurerm_log_analytics_workspace" "management" {
  ...
  internet_ingestion_access_type     = var.log_analytics_workspace_internet_ingestion_enabled ? "Enabled" : "Disabled"
  internet_query_access_type         = var.log_analytics_workspace_internet_query_enabled ? "Enabled" : "Disabled"
